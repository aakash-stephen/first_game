...
while not game_quit:
    ...
    if (x1 > 0 and x1 + 80 < width) or (x1 == 0 and x1_change > 0) or ( x1 + 80 == width and x1_change <0):
        x1 += x1_change
    if (y1 + 80 > 0.85 * height):
        #if (y1 + 80 == platform_ypos * 3 and platform_xpos1 <= x1 + 40 and x1 <= width*0.2 +40 and y1_change < 0):
        g = 0
        #else:
            #if y1 + 80 == platform_ypos * 3 and platform_xpos1 <= x1 + 40 and x1 <= width*0.2 +40 ==0:
                #y1 += y1_change
    if (((y1 + 80 < platform_ypos * 3 + 10 and y1 + 80 > platform_ypos * 3) or (y1 + 80 < platform_ypos + 10 and y1 + 80 > platform_ypos))  and platform_xpos1 <= x1 + 30 and x1 + 10 <= width*0.2 ):
        g = 0
    if ((y1 + 80 < platform_ypos * 2 + 10 and y1 + 80 > platform_ypos * 2) and platform_xpos2 <= x1 +30 and x1 + 10 <= width*0.4):
        g = 0
